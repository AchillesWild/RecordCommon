...
public enum ModelFunctionEnum {
    ...
    FINANCE_DATE_LIST_DATE_RANGE(ClzConstant.FINANCE_DATE_QUERY + ".getMapListByMonth", ModelEnum.FINANCE_DATE.getKey(),"getMapListByMonth", ModelEnum.FINANCE_DATE.getValue() + "_根据月份查询map"),
    ...
    FINANCE_DATE_GET_DETAIL_LIST(ClzConstant.FINANCE_DATE_QUERY + ".getDetailListByDate", ModelEnum.FINANCE_DATE.getKey(),"getDetailListByDate", ModelEnum.FINANCE_DATE.getValue() + "_根据天获取详细"),
