...
public enum ModelFunctionEnum {
    ...
    FINANCE_DEL_GET(ClzConstant.FINANCE_COMMAND + ".deleteAndGet", ModelEnum.FINANCE.getKey(),"deleteAndGet", ModelEnum.FINANCE.getValue() + "_删除查询"),
    ...
    FINANCE_DATE_LIST_DATE_RANGE(ClzConstant.FINANCE_DATE_QUERY + ".getMapListByMonth", ModelEnum.FINANCE_CALENDAR.getKey(),"getMapListByMonth", ModelEnum.FINANCE_CALENDAR.getValue() + "_根据月份查询map"),
    ...
    FINANCE_DATE_GET_DETAIL_LIST(ClzConstant.FINANCE_DATE_QUERY + ".getDetailListByDate", ModelEnum.FINANCE_CALENDAR.getKey(),"getDetailListByDate", ModelEnum.FINANCE_CALENDAR.getValue() + "_根据天获取详细"),
    ...
    PRODUCT_OUTPUT_WEEK_LIST(ClzConstant.PRODUCT_OUTPUT_WEEK_QUERY + ".getPageList", ModelEnum.PRODUCT_OUTPUT_WEEK.getKey(),"getPageList", ModelEnum.PRODUCT_OUTPUT_WEEK.getValue() + "_查询列表"),
    PRODUCT_OUTPUT_WEEK_LIST_WEEK(ClzConstant.PRODUCT_OUTPUT_WEEK_QUERY + ".getWeekPageList", ModelEnum.PRODUCT_OUTPUT_WEEK.getKey(),"getWeekPageList", ModelEnum.PRODUCT_OUTPUT_WEEK.getValue() + "_查询列表"),
    PRODUCT_OUTPUT_WEEK_GET_SUM(ClzConstant.PRODUCT_OUTPUT_WEEK_QUERY + ".getSumNumber", ModelEnum.PRODUCT_OUTPUT_WEEK.getKey(),"getSumNumber", ModelEnum.PRODUCT_OUTPUT_WEEK.getValue() + "_查询某个计量物的汇总"),
    ...
    PRODUCT_OUTPUT_MONTH_LIST_MONTH(ClzConstant.PRODUCT_OUTPUT_MONTH_QUERY + ".getMonthPageList", ModelEnum.PRODUCT_OUTPUT_MONTH.getKey(),"getMonthPageList", ModelEnum.PRODUCT_OUTPUT_MONTH.getValue() + "_查询列表"),
    ...
    PRODUCT_OUTPUT_YEAR_LIST_YEAR(ClzConstant.PRODUCT_OUTPUT_YEAR_QUERY + ".getYearPageList", ModelEnum.PRODUCT_OUTPUT_YEAR.getKey(),"getYearPageList", ModelEnum.PRODUCT_OUTPUT_YEAR.getValue() + "_查询列表"),
