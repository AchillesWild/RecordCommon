...
public enum FinanceDownloadTypeEnum {
    ...
    FINANCE_DATE_CLASSIFIED_DATE(11,"FINANCE_DATE_CLASSIFIED_DATE"),
    ...
    FINANCE_TO_INCOME_LIST(70, "FINANCE_TO_INCOME_LIST"),
    FINANCE_TO_PAY_LIST(80, "FINANCE_TO_PAY_LIST"),
    ;
